...
def rc_init(dev_path, data_path, bucket_size, forecast_depth, mode):
	...
	params['visual'] = False
	params['gpu'] = True
	#multiply the tracker box with this factor
	params['radius'] = 1.5
	#nomalize the cropped image from tracker
	params['resize'] = 227
	#the layer outputs x y 
	params['output_layer'] = 'fc2'

	#network inner parameters
	rc_path['solver'] = dev_path + '/rc_solver_' + mode + '.prototxt'

	#input data generated by matlab
